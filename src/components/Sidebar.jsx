...
const Sidebar = () => {
  ...
  return (
    <div className={` flex-col h-screen absolute z-50 w-1/2 md:relative md:w-1/6 bg-white text-black border-r-[1px] border-gray-300 ${ActiveMenuS?'hidden ':'flex'}`}>
      {/* Sidebar Top Div  */}
...
<div className='flex items-center justify-center gap-5 text-3xl'>
  ...
  <BsFillSquareFill className='cursor-pointer '/>
